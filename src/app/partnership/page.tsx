...
const Partnership: React.FC = () => {
  ...
  return (
    <div
      className={`h-screen w-screen max-w-md flex flex-col items-center mx-auto`}
    >
      ...
      <div className='bg-customYellow text-white text-center p-6 w-full bg-text-white'>
        <h1
          className={`text-3xl font-bold ${museoModerno.className} text-white`}
        >
          Partnership
        </h1>
        <p className={`mt-2 text-left text-white ${museoModerno.className}`}>
          Take part in Los and start reaching people for free! Just offer
          rewards to our community to join Los. No fees, just mutual benefits.
        </p>
      </div>
      ...
      {showAskForm && (
        <div className={`w-full h-full mt-4 ${museoModerno.className}`}>
          ...
          >
            <div className='mb-4'>
              <p className='my-2 '>
                As a Los partner, you can start listing your events on Los and
                reach new people. You can start posting your events and offer
                rewards to Los community. We will reach you out after you send
