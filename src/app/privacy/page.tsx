    ...
    return (
        <div className={`h-screen w-screen p-4 flex flex-col items-center`}>
            ...
            <div className='privacy-policy text-left max-w-3xl'>
                <p>
                    <strong>Last updated: August 09, 2024</strong>
                </p>
                <p>
                ...
                <ul className='list-disc list-inside ml-6'>
                    ...
                    <li>
                        <strong>Website</strong> refers to Los, accessible from los.city
                    </li>
                    <li>
                ...
                <h2 className='text-xl font-bold mt-6'>Collecting and Using Your Personal Data</h2>
                ...
                <h3 className='text-lg font-semibold mt-4'>Tracking Technologies and Cookies</h3>
                <p>
                ...
                <h2 className='text-xl font-bold mt-6'>Use of Your Personal Data</h2>
                ...
                <h2 className='text-xl font-bold mt-6'>Retention of Your Personal Data</h2>
                <p>
                ...
                <h2 className='text-xl font-bold mt-6'>Delete Your Personal Data</h2>
                <p>
                ...
                <h2 className='text-xl font-bold mt-6'>Disclosure of Your Personal Data</h2>
                <h3 className='text-lg font-semibold mt-4'>Business Transactions</h3>
                <p>
                ...
                <h3 className='text-lg font-semibold mt-4'>Law enforcement</h3>
                <p>
                ...
                <h3 className='text-lg font-semibold mt-4'>Other legal requirements</h3>
                <p>
                ...
                <h2 className='text-xl font-bold mt-6'>Security of Your Personal Data</h2>
                <p>
                ...
                <h2 className='text-xl font-bold mt-6'>Usage, Performance and Miscellaneous</h2>
                ...
                <ul className='list-disc list-inside ml-6'>
                    <li>By email: support@los.city</li>
                </ul>
            </div>
        </div>
    )
